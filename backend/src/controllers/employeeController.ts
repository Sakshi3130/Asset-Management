...
import {
    ...
    editProfile,
    getMyRequestsQuery,
    getAvailableAssetsToRequestQuery,
...
export const getAvailableAssetsToRequest = async (req: Request, res: Response): Promise<void> => {
    try {
        const employeeId = parseInt(req.params.employeeId);
        const assets = await getAvailableAssetsToRequestQuery(employeeId);
