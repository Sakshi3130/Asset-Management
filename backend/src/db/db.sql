...
INSERT INTO employees(email, firstname, lastname, role, password, date_of_joining, location,
                      phone_number)
VALUES ('sakshi@gmail.com', 'sakshi','bhingardive','admin','$2b$10$pyyGFNXMyHW4.ROabg0ZxOa/gO49V2xaPVRja2ZI47h7Ac2f2s/ui','2024-11-21','pune',9881955564);

ALTER TABLE "assets" ADD FOREIGN KEY ("employee_id") REFERENCES "employees" ("id");

ALTER TABLE "request_asset" ADD FOREIGN KEY ("id") REFERENCES "employees" ("id");

ALTER TABLE "request_asset" ADD FOREIGN KEY ("id") REFERENCES "assets" ("id");
